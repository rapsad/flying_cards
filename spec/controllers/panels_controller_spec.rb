...
RSpec.describe PanelsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all panels as @panels" do
      ...
      expect(assigns(:panels)).to eq([panel])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created panel as @panel" do
        post :create, {:panel => valid_attributes}, valid_session
        expect(assigns(:panel)).to be_a(Panel)
        expect(assigns(:panel)).to be_persisted
      end

      it "redirects to the created panel" do
        post :create, {:panel => valid_attributes}, valid_session
        expect(response).to redirect_to(Panel.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved panel as @panel" do
        post :create, {:panel => invalid_attributes}, valid_session
        expect(assigns(:panel)).to be_a_new(Panel)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested panel" do
        panel = Panel.create! valid_attributes
        put :update, {:id => panel.to_param, :panel => new_attributes}, valid_session
        panel.reload
    ...
    context "with invalid params" do
      it "assigns the panel as @panel" do
        panel = Panel.create! valid_attributes
        put :update, {:id => panel.to_param, :panel => invalid_attributes}, valid_session
        expect(assigns(:panel)).to eq(panel)
      end
